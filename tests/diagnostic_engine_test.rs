...
fn test_add_multiple_diagnostics() {
    ...
    engine.add(
        uri.clone(),
        create_test_diagnostic("Error 1", DiagnosticSeverity::ERROR),
    );
    engine.add(
        uri.clone(),
        create_test_diagnostic("Warning 1", DiagnosticSeverity::WARNING),
    );
    engine.add(
        uri.clone(),
        create_test_diagnostic("Info 1", DiagnosticSeverity::INFORMATION),
    );
...
fn test_add_diagnostics_to_different_files() {
    ...
    engine.add(
        uri1.clone(),
        create_test_diagnostic("Error in file 1", DiagnosticSeverity::ERROR),
    );
    engine.add(
        uri2.clone(),
        create_test_diagnostic("Error in file 2", DiagnosticSeverity::ERROR),
    );
...
fn test_clear_diagnostics() {
    ...
    engine.add(
        uri.clone(),
        create_test_diagnostic("Error", DiagnosticSeverity::ERROR),
    );
    engine.add(
        uri.clone(),
        create_test_diagnostic("Warning", DiagnosticSeverity::WARNING),
    );
...
fn test_clear_does_not_affect_other_files() {
    ...
    engine.add(
        uri2.clone(),
        create_test_diagnostic("Error 2", DiagnosticSeverity::ERROR),
    );
...
fn test_diagnostic_severity_levels() {
    ...
    engine.add(
        uri.clone(),
        create_test_diagnostic("Info", DiagnosticSeverity::INFORMATION),
    );
    engine.add(
        uri.clone(),
        create_test_diagnostic("Hint", DiagnosticSeverity::HINT),
    );
